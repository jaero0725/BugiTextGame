...
public class LoseGameFrame extends JFrame {
	...
	private ImageIcon gameOver = new ImageIcon("resource/img/lose.jpg");
	
	public LoseGameFrame() {}
	public LoseGameFrame(int score, String id, int time) {
		loseGamePanel = new LoseGamePanel(score, id, time);
		...
		getContentPane().add(loseGamePanel);
	...
	class LoseGamePanel extends JPanel {
		...
		public LoseGamePanel(int score, String id, int time) {
			this.score = score;
			this.id = id;
			this.time = time;
